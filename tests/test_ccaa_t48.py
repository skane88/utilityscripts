...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1.45, LoadingType.POINT, LoadLocation.INTERNAL, 1.20),
        (2.00, LoadingType.POINT, LoadLocation.INTERNAL, 1.48),
        (1.45, LoadingType.POINT, LoadLocation.EDGE, 1.20),
        (2.00, LoadingType.POINT, LoadLocation.EDGE, 1.48),
